        ...
        <section class="panel panel-default mt-5">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('storeProduct') }}" method="post" enctype="multipart/form-data">
                    ...
                    {{-- <div class="col-sm-3 mt-3">
                        <label class="control-label small" for="date_start">Category select</label>
                        <input type="text" class="form-control" name="cat_select[0]" id="cat_select[0]"
                            placeholder="cat select">
                    </div>
                    <div class="form-group">
                        <label for="tech" class="col-sm-3 control-label">Category name</label>
                        <div class="col-sm-3">
                            <select name="cat_name" id="cat_name" class="form-select form-select-sm mb-1" required>
                                <option value="">Select content category *</option>

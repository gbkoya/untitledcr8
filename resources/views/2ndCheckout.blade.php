        ...
        <div class="px-5 justify-content-center">
            <form class="px-5">
                <div class="form-group col-lg-9 mt-5">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="hello@dummie.org">
                </div>
                <div class="form-group col-lg-9 mt-5">
                    ...
                    <div class="d-flex">
                        ...
                        <input style="border: 1.14951px solid #D2D6DA;border-radius: 5.74757px;height: 46px; max-width:9095px" class="" name="phone" type="text" class="form-control" id="phone" placeholder="">

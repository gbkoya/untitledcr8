...
<div class="container col-md-5 my-5 py-5 king">
    ...
    <form class=" px-5">
      ...
      <div class="mb-3 form-check pt-4">
        <div class="d-flex flex-row justify-content-center">
          ...
          <label  class="Remember form-check-label pt-2 px-2" for="exampleCheck1">I agree to the terms and conditions</label>
        </div>
      </div>

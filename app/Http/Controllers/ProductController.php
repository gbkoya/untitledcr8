...
class ProductController extends Controller
{
    ...
    /**
        ...
        * description="Get the detail of a particular product. Comes with product price and features. Product ID must be passed in the url",
        *     @OA\RequestBody(
        *         @OA\JsonContent(),
        *         @OA\MediaType(
        ...
        *            @OA\Schema(
        *               type="object",
        *               @OA\Property(property="product_id", type="text"),
        *            ),
        *        ),
        *    ),
        *      @OA\Response(
    ...
    */
    ...
    /**
        ...
        * description="Gets all products under the requested category. Product ID must be passed in the url",
        *     @OA\RequestBody(
        *         @OA\JsonContent(),
        *         @OA\MediaType(
        *            mediaType="multipart/form-data",
    ...
    */
    ...
    /**
        ...
        * description="Add a new product to the system. The product price, features and images are also added",
        *     @OA\RequestBody(
        *         @OA\JsonContent(),
        *         @OA\MediaType(
        *            mediaType="multipart/form-data",
        ...
        *               @OA\Property(property="product_price", type="text"),
        *            ),
        *        ),
        *    ),
        *      @OA\Response(
    ...
    */
    ...
    /**
        ...
        * description="Change or edit a product. Especially the product price. Product ID must be passed in the url",
        *     @OA\RequestBody(
        *         @OA\JsonContent(),
        *         @OA\MediaType(
        *            mediaType="multipart/form-data",
    ...
    */
    ...
    /**
        ...
        * description="Remove a product from the system. Product ID must be passed in the url",
        *     @OA\RequestBody(
        *         @OA\JsonContent(),
        *         @OA\MediaType(
        *            mediaType="multipart/form-data",
